...
class Board extends JPanel {
    ...
    // cc never used outside constructor to make white circles, can be made into local var
    //private Circle winCircle;
    // winCircle never used
    private int drawCounter;
    //private static ArrayList<Circle> circleHolder;
    // circleHolder never used outside constructor
    ...
    */
     ...
     * for all possible four in a row patterns and draw
     * small green circles over winning circles
     *
    ...
    /**
     * Checks the Board object for diagonal winning circles
     * both on main diagonal \ and anti-diagonal /
     * Calls drawMainDiagonalWin  or drawAntiDiagonalWin
     * if winning circles found
     *
     * @param g
     */
    private void checkDiagonal(Graphics g) {
    ...
    /**
     * Checks the Board object for vertical winning circles
     * Calls drawHorizontalWin if winning circles found
     *
     * @param g
     */
    private void checkVertical(Graphics g) {
    ...
    /**
     * Checks the Board object for Horizontal winning circles
     * Calls drawHorizontalWin if winning circles found
     *
     * @param g
     */
    private void checkHorizontal(Graphics g) {
     ...
     * @param col
     */
    private void drawHorizontalWin(Graphics g, int row, int col) {
        Circle winCircle;
        for (int i = 0; i < 4; i++) {
